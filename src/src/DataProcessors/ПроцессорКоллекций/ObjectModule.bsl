...
Процедура УстановитьКоллекцию(НоваяКоллекция) Экспорт
	ПроцессорыКоллекцийСлужебный.УстановитьКоллекцию(Коллекция, КэшКолонок, НоваяКоллекция);
КонецПроцедуры
...
Функция Первые(Количество) Экспорт
	...
	ПроцессорыКоллекцийСлужебный.Первые(Конвейер, Количество);
...
Функция Пропустить(Количество) Экспорт
	...
	ПроцессорыКоллекцийСлужебный.Пропустить(Конвейер, Количество);
...
Функция Различные(Знач ФункцияСравнения = Неопределено, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПроцессорыКоллекцийСлужебный.Различные(
		Конвейер,
		ФункцияСравнения,
...
Функция Обработать(Знач ФункцияОбработки, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПроцессорыКоллекцийСлужебный.Обработать(
		Конвейер,
		ФункцияОбработки,
		ДополнительныеПараметры
	);
...
Функция Развернуть(Знач ФункцияРазворачивания, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПроцессорыКоллекцийСлужебный.Развернуть(
		Конвейер,
...
Функция Фильтровать(Знач ФункцияФильтрации, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПроцессорыКоллекцийСлужебный.Фильтровать(
		Конвейер,
		ФункцияФильтрации,
		ДополнительныеПараметры
	);
...
Функция Сортировать(Знач ФункцияСравнения = Неопределено, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПроцессорыКоллекцийСлужебный.Сортировать(
		Конвейер,
		ФункцияСравнения,
		ДополнительныеПараметры
	);
...
Функция СортироватьПо(
	...
	ПроцессорыКоллекцийСлужебный.СортироватьПо(
		Конвейер,
		ИмяПоля,
		ФункцияСравнения,
		ДополнительныеПараметры
...
Функция ПолучитьПервый() Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.ПолучитьПервый(
		Конвейер,
		Коллекция,
		КэшКолонок
	);
...
Функция ВМассив() Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.ВМассив(
		Конвейер,
		Коллекция,
		КэшКолонок
	);
...
Функция ВСтроку(РазделительСтрок = "") Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.ВСтроку(
		Конвейер,
		Коллекция,
		КэшКолонок,
		РазделительСтрок
...
Функция Количество() Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.Количество(
		Конвейер,
		Коллекция,
		КэшКолонок
	);
...
Процедура ДляКаждого(Знач ФункцияОбработки, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПроцессорыКоллекцийСлужебный.ДляКаждого(
		Конвейер,
		Коллекция,
		КэшКолонок,
		ФункцияОбработки,
...
Функция Минимум(Знач ФункцияСравнения = Неопределено, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.Минимум(
		Конвейер,
		Коллекция,
		КэшКолонок,
		ФункцияСравнения,
...
Функция Максимум(Знач ФункцияСравнения = Неопределено, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.Максимум(
		Конвейер,
		Коллекция,
		КэшКолонок,
		ФункцияСравнения,
...
Функция Сократить(
	...
	Возврат ПроцессорыКоллекцийСлужебный.Сократить(
		Конвейер,
		Коллекция,
		КэшКолонок,
		ФункцияСокращения,
...
Функция Получить(ТипРезультата) Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.Получить(
		Конвейер,
		Коллекция,
		КэшКолонок,
		ТипРезультата
...
Функция ЛюбойСоответствует(Знач ФункцияСравнения, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.ЛюбойСоответствует(
		Конвейер,
		Коллекция,
		КэшКолонок,
		ФункцияСравнения,
...
Функция ВсеСоответствуют(Знач ФункцияСравнения, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.ВсеСоответствуют(
		Конвейер,
		Коллекция,
		КэшКолонок,
		ФункцияСравнения,
...
Функция ВсеНеСоответствуют(Знач ФункцияСравнения, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ПроцессорыКоллекцийСлужебный.ВсеНеСоответствуют(
		Конвейер,
		Коллекция,
		КэшКолонок,
		ФункцияСравнения,
