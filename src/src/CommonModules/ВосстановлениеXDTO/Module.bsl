...
Функция ВосстановитьЗначениеXDTO(Свойство, Тип, Значение, ДопПараметры) Экспорт
	Результат = Значение;
	ВосстановлениеXDTOПереопределяемый.ВосстановитьЗначениеXDTO(Результат, Свойство, Тип, Значение, ДопПараметры);
	Возврат Значение;
КонецФункции
...
Функция КонвертироватьИзФормата(ОбъектXDTO, ФункцииВосстановления = Неопределено,
	...
	ВосстановлениеXDTOПереопределяемый.КонвертироватьИзФормата(
		Результат,
		ОбъектXDTO,
...
Функция ВосстановитьОбъектXDTO(ОбъектXDTO, ФункцииВосстановления, ДопПараметры)
	...
	Для Каждого Свойство Из ОбъектXDTO.Свойства() Цикл
		...
		ОбработатьВосстановление(ФункцииВосстановления, Значение, ИмяСвойства, ДопПараметры);
...
Процедура ОбработатьВосстановление(ФункцииВосстановления, Значение, ИмяСвойства, ДопПараметры)
