...
Функция ПараметрыЗапроса(Запрос, ПроверяемыеПараметры) Экспорт
	...
	Для Каждого ЗапрашиваемыйПараметр Из ПроверяемыеПараметры Цикл
		...
		ИначеЕсли Тип = "ДАТА" Тогда
			Попытка
				ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("http://www.w3.org/2001/XMLSchema", "date"), ЗначениеПараметра);
		...
		ИначеЕсли Тип = "ДАТА_ВРЕМЯ" Тогда
			Попытка
				ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("http://www.w3.org/2001/XMLSchema", "dateTime"), ЗначениеПараметра);
				ПараметрыЗапроса.Вставить(ЗапрашиваемыйПараметр.Имя, ЗначениеПараметра);
			Исключение
...
// Параметры:
//  Имя - Строка - Имя
//  Тип - Строка - Описание типа строкой (Число,Строка,Булево,Ид,Дата,ДатаВремя)
...
// * Имя - Строка
// * Обязательный - Булево
// * Тип - Строка - Тип строкой "Число", "Строка", "Булево", "Дата", "ДатаВремя" или "Ид"
